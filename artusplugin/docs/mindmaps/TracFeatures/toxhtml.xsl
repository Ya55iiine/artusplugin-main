...
<xsl:param name="destination_dir">http://vm11.artus.dom/TracFeatures/</xsl:param>
...
<xsl:param name="show_icons">false</xsl:param>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
	...
	<xsl:element name="link">
		...
		<xsl:attribute name="href">
			<xsl:value-of select="$destination_dir"/>themes/default/style.css</xsl:attribute>
		<xsl:attribute name="type">text/css</xsl:attribute>
	</xsl:element>
	<xsl:element name="script">
		<xsl:attribute name="type">text/javascript</xsl:attribute>
		<xsl:attribute name="src">http://vm11.artus.dom/htdocs/jquery-3.1.0.min.js</xsl:attribute>&#160;
	</xsl:element>
	<xsl:element name="script">
		<xsl:attribute name="type">text/javascript</xsl:attribute>
		<xsl:attribute name="src">
			<xsl:value-of select="$destination_dir"/>jstree.min.js</xsl:attribute>&#160;
	</xsl:element>
	<xsl:element name="script">
		<xsl:attribute name="type">text/javascript</xsl:attribute>
		<xsl:attribute name="src">
			<xsl:value-of select="$destination_dir"/>TracFeatures.js</xsl:attribute>&#160;
	</xsl:element>
</head>
